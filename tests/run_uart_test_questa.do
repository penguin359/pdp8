...
vlog $args -work uvm_questa +define+UVM_NO_DPI +incdir+../../uvm-1.2/src -dpiheader dpi_export.h {../../uvm-1.2/src/uvm_pkg.sv}
...
#vsim $args -L uvm_questa -classdebug -sv_lib uvm_dpi64 +UVM_VERBOSITY=UVM_HIGH uart_tb_top
